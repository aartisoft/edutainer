...
public class SplashActivity extends AppCompatActivity implements SplashContract.SplashView {
    ...
    public static ArrayList<CourseModel> enrolledCourses = new ArrayList<>();
    ...
    @Override
    public void handleEnrolled(String string) {
        System.out.println("SplashActivity: handleEnrolled: " + string);
        if (string.equalsIgnoreCase("No network")){
            //show no network available
            runOnUiThread(new Runnable() {
                @Override
...
//                        String cat_name = jsonObject.getString("name");
                        String status = jsonObject.getString("status");
                        String web_img = jsonObject.getString("web_img");

                        enrolledCourses.add(new CourseModel(
                                category_id,
                                course_cost,
                                course_desc,
                                course_duration,
